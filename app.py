...
def index():
    ...
    return render_template('index.html', projects=projects, skills=skills, education=education)
...
def admin():
    ...
    skills = Skill.query.all()
    education = Education.query.all()
    return render_template('admin.html', projects=projects, skills=skills, education=education)
